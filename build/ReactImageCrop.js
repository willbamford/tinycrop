...
var ImageCrop = function(opts) {
	...
	// this.defaultSize = opts.defaultSize || {width: 400, height: 300};

	this.parent.appendChild(this.canvas);

	window.addEventListener('resize', this.autoSizeAndPaint.bind(this));
...
ImageCrop.prototype.autoSizeAndPaint = function() {
	this.autoSize();
	this.paint();
};
...
ImageCrop.prototype.paint = function() {
	...
	if (image) {
		g.drawImage(image, 0, 0, image.naturalWidth, image.naturalHeight, 0, 0, canvas.width, canvas.height);
	}
};

ImageCrop.prototype.autoSize = function() {
	var width = this.parent.clientWidth;
	var image = this.image;
	var canvas = this.canvas;

	var imageWidth = image ? image.naturalWidth : this.defaultSize.width;
	var imageHeight = image ? image.naturalHeight : this.defaultSize.height;

	var width = this.parent.clientWidth;
	var height = Math.floor(imageHeight / imageWidth * width);
...
},{"image-loaded":2}],160:[function(require,module,exports){
...
},{"./ImageCrop.js":159,"react":158}]},{},[160]);
