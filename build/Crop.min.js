...
var BackgroundLayer=function(r){r=r||{},this.backgroundColor=r.backgroundColor,this.foregroundColor=r.foregroundColor,this.parent=r.parent,this.context=r.context,this.isDirty=!0};BackgroundLayer.create=function(r){return new BackgroundLayer(r)},BackgroundLayer.prototype.revalidate=function(){this.isDirty=!0},BackgroundLayer.prototype.paint=function(){if(this.isDirty){var r=this.parent,t=this.context;t.fillStyle=this.backgroundColor,t.fillRect(0,0,r.width,r.height);var o=(r.width,r.height),i=32,e=r.width/i,n=Math.ceil(o/e);t.fillStyle=this.foregroundColor;for(var a=0,c=0;i>c;c+=1)for(var h=0;n>h;h+=1)(c+h)%2===0&&t.fillRect(c*e,h*e,e,e),a+=1;this.isDirty=!1}},module.exports=BackgroundLayer;


},{}],2:[function(require,module,exports){
function noop(){}function isPercent(e){return"string"!=typeof e?!1:e.length<1?!1:"%"===e[e.length-1]?!0:void 0}function getPercent(e){return isPercent(e)?e.slice(0,-1):0}function isAuto(e){return"auto"===e}function isInteger(e){return"number"==typeof e&&Math.round(e)==e}var debounce=require("./debounce.js"),BackgroundLayer=require("./BackgroundLayer.js"),ImageLayer=require("./ImageLayer.js"),SelectionLayer=require("./SelectionLayer.js"),Image=require("./Image.js"),Listeners=require("./Listeners.js"),DEFAULT_CANVAS_WIDTH=400,DEFAULT_CANVAS_HEIGHT=300,Crop=function(e){this.parent="string"==typeof e.parent?document.querySelector(e.parent):e.parent,this.canvas=document.createElement("canvas"),this.context=this.canvas.getContext("2d"),this.boundsOpts=e.bounds||{width:"100%",height:"auto"},e.selection=e.selection||{},this.backgroundColor=e.backgroundColor||"#fff",this.foregroundColor=e.foregroundColor||"#f7f7f7",this.debounceResize=void 0!==e.debounceResize?e.debounceResize:!0,this.listeners=Listeners.create(),this.parent.appendChild(this.canvas),this.backgroundLayer=BackgroundLayer.create({parent:this,context:this.context,backgroundColor:this.backgroundColor,foregroundColor:this.foregroundColor}),this.imageLayer=ImageLayer.create({parent:this,context:this.context,image:this.image}),this.selectionLayer=SelectionLayer.create({parent:this,context:this.context,target:this.imageLayer,aspectRatio:e.selection.aspectRatio,minWidth:e.selection.minWidth,minHeight:e.selection.minHeight,x:e.selection.x,y:e.selection.y,width:e.selection.width,height:e.selection.height,handle:{color:e.selection.color,activeColor:e.selection.activeColor}});var t=this.listeners,i=this.paint.bind(this);this.selectionLayer.on("start",function(e){i(),t.notify("start",e)}).on("move",function(e){t.notify("move",e)}).on("resize",function(e){t.notify("resize",e)}).on("change",function(e){i(),t.notify("change",e)}).on("end",function(e){i(),t.notify("end",e)}),window.addEventListener("resize",this.debounceResize?debounce(this.revalidateAndPaint.bind(this),100):this.revalidateAndPaint.bind(this)),this.setImage(e.image),this.revalidateAndPaint()};Crop.create=function(e){return new Crop(e)},Crop.prototype.on=function(e,t){return this.listeners.on(e,t),this},Crop.prototype.off=function(e,t){return this.listeners.off(e,t),this},Crop.prototype.revalidateAndPaint=function(){this.revalidate(),this.paint()},Crop.prototype.revalidate=function(){var e=this.parent,t=(this.canvas,this.image),i=this.boundsOpts.width,n=this.boundsOpts.height,o=0,r=0;o=isInteger(i)?i:e&&isPercent(i)?Math.round(e.clientWidth*getPercent(i)/100):DEFAULT_CANVAS_WIDTH,r=isInteger(n)?n:isPercent(n)?Math.round(o*getPercent(n)/100):t&&t.hasLoaded&&isAuto(n)?Math.floor(o/t.getAspectRatio()):DEFAULT_CANVAS_HEIGHT,this.resizeCanvas(o,r),this.backgroundLayer.revalidate(),this.imageLayer.revalidate(),this.selectionLayer.revalidate()},Crop.prototype.paint=function(){var e=this.context;e.save(),e.scale(this.ratio,this.ratio),this.backgroundLayer.paint(),this.image&&this.image.hasLoaded&&(this.imageLayer.paint(),this.selectionLayer.paint()),e.restore()},Crop.prototype.resizeCanvas=function(e,t){var i=this.context,n=this.canvas;this.ratio=1,i.webkitBackingStorePixelRatio||(this.ratio=window.devicePixelRatio||1),this.width=e,this.height=t,n.width=this.width*this.ratio,n.height=this.height*this.ratio},Crop.prototype.setImage=function(e){var t=Image.create(e).on("load",function(){this.selectionLayer.onImageLoad(),this.revalidateAndPaint()}.bind(this)).on("error",function(e){alert(e),console.error(e)}.bind(this));this.imageLayer.setImage(t),this.image=t,this.revalidateAndPaint()},Crop.prototype.dispose=noop,module.exports=Crop;
...
var Listeners=require("./Listeners.js"),Input=function(n){function t(n){var t=n.offsetX,e=n.offsetY;return{source:n,x:t,y:e,dx:o?t-o.x:0,dy:o?e-o.y:0,type:"Mouse"}}function e(n){var t=n.target.getBoundingClientRect(),e=n.touches.length>0?n.touches[0]:n.changedTouches[0],i=e.pageX-t.left,u=e.pageY-t.top;return{source:n,x:i,y:u,dx:o?i-o.x:0,dy:o?u-o.y:0,type:"Touch"}}var i=Listeners.create(),o=null;this.listeners=i,n.addEventListener("mousedown",function(n){o=t(n),i.notify("down",o)}.bind(this)),n.addEventListener("touchstart",function(n){o=e(n),i.notify("down",o)}.bind(this)),n.addEventListener("mousemove",function(n){i.notify("move",t(n))}.bind(this)),n.addEventListener("touchmove",function(n){i.notify("move",e(n))}.bind(this)),n.addEventListener("mouseup",function(n){i.notify("up",t(n))}.bind(this)),n.addEventListener("touchend",function(n){i.notify("up",e(n)),o=null}.bind(this)),n.addEventListener("mouseout",function(n){i.notify("cancel",t(n)),o=null}.bind(this)),n.addEventListener("touchcancel",function(n){i.notify("cancel",e(n)),o=null}.bind(this))};Input.create=function(n){return new Input(n)},Input.prototype.on=function(n,t){return this.listeners.on(n,t),this},Input.prototype.off=function(n,t){return this.listeners.off(n,t),this},module.exports=Input;


},{"./Listeners.js":6}],6:[function(require,module,exports){
var Listeners=function(t){this.events={}};Listeners.create=function(t){return new Listeners(t)},Listeners.prototype.on=function(t,e){return this.events[t]||(this.events[t]=[]),-1===this.events[t].indexOf(e)&&this.events[t].push(e),this},Listeners.prototype.off=function(t,e){if(this.events[t]){var s=this.events[t].indexOf(e);-1!==s&&this.events[t].splice(s,1)}return this},Listeners.prototype.notify=function(t,e){this.events[t]&&this.events[t].forEach(function(t){t.call(this,e)}.bind(this))},Listeners.prototype.clearAll=function(){this.events={}},module.exports=Listeners;
